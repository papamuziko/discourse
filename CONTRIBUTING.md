...
Anyone wishing to contribute to the [github.com/papamuziko/discourse](https://github.com/papamuziko/discourse) project **must read & sign our [Contributor License Agreement](http://www.discourse.org/cla)**. The Discourse team is legally prevented from accepting any pull requests from users who have not signed the CLA first.
